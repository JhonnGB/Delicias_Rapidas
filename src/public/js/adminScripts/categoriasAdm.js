...
function mostrarVentanaCrear() {
    ...
    // Hacer una solicitud GET para obtener el HTML de la vista 'crear'
    fetch('/adm/crear', {
        method: 'GET',
        headers: {
...
function mostrarVentanaEliminar(index) {
    ...
    // Agregar un event listener al botón "Cancelar"
    document.getElementById("cancelarEliminar" + index).addEventListener("click", function() {
...
function mostrarVentanaEditar(index, recursoId) {
    ...
    fetch(`/adm/editar-categoria?recursoId=${recursoId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'text/html',
        },
    ...
    .then(html => {
        ...
        document.getElementById("cancelarEditar" + index).addEventListener("click", function(event) {
